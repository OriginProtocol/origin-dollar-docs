...
7. Push your branch to the upstream repository \(i.e. [https://github.com/OriginProtocol/\[repo\]\](https://github.com/OriginProtocol/[repo]\)\) so that other contributors can easily work off of it if necessary.
