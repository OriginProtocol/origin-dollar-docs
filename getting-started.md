...
Производство OUSD позволяет любому создавать или торговать токенами OUSD, используя наш [DApp](https://github.com/oplabs/origin-dollar-docs/tree/b479bf054fb28323cb1f72b88e7ecdbd08aa526f/www.ousd.com) и кошелек для криптовалюты с поддержкой web-3, например [Metamask](https://www.metamask.io). Это естественный способ получить OUSD, особенно если вам нужна крупная сумма, которая может привести к движению рынка на других биржах.
...
{% page-ref page="smart-kontrakty/api/" %}

**Помощь**

Присоединяйтесь к Origin Dollar\#engineering room на сервере Origin в [Discord](https://github.com/oplabs/origin-dollar-docs/tree/b479bf054fb28323cb1f72b88e7ecdbd08aa526f/www.originprotocol.com/discord/README.md). Наша команда и члены нашего сообщества с нетерпением ждут возможности помочь Вам в разработке. Ваши вопросы помогают нам стать лучше, поэтому не стесняйтесь спрашивать, если вы не можете найти здесь то, что ищете.
