...
Prior to full decentralized governance, we will implement a [timelock](../hop-dong-thong-minh/api/timelock.md) in front of all admin function calls, giving OUSD users time \(48 hours\) to withdraw their funds if they have objections to our proposed upgrades. This timelock will be added shortly after launch.

**New and Existing Stakeholders**

OUSD is a new project founded by Origin Protocol [team](https://github.com/oplabs/origin-dollar-docs/tree/bce1f906df7a51fa677f7a5418820d4d732448d7/governance/www.originprotocol.com/team/README.md) and will be supported by the existing Origin community as well as many new stakeholders that choose to mint, hold, use, and provide liquidity for OUSD.
