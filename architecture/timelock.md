...
{% hint style="danger" %}
The timelock will be added soon after we have verified everything is working as intended. Until then, the contracts will be governed by Origin's 5 of 8 multi-sig. This allows for a faster response if any critical issues are discovered.
{% endhint %}
